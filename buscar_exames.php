    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="container mt-5">
                        ...
                        <form method="POST" id="filtro-form" style="margin-bottom: 20px;">
                            <div class="form-row">
                                <div class="col">
                                    <input type="text" name="nome_exame" class="form-control"
                                        placeholder="Nome do Exame" value="<?php echo $nomeExame; ?>">
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <input type="text" name="nome_medico" class="form-control"
                                        placeholder="Nome do Médico" value="<?php echo $nomeMedico; ?>">
                                </div>
                                <div class="col">
                ...
                filterBtn.addEventListener("change", toggleFilter);
                </script>
    </body>
</html>